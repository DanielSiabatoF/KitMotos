...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="hidden" name="tipo_persona" id="tipo_persona" value="3">
     ...
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="number" name="num_documento" id="num_documento" maxlength="20" placeholder="Número de Documento" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
