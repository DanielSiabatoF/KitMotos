...
if (!isset($_SESSION['nombre'])) {
    ...
    if ($_SESSION['autorizacion'] == 1) {
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h1 class="box-title">Autorizaciones
                                    <button type="button" onclick="actualizar()" class="btn btn-info"><i
        ...
        <!--Modal2-->
        <div class="modal fade" id="VentaPendiente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" style="width: 65% !important;">
                <div class="modal-content">
                    <div class="modal-header">
