...
<head>
  ...
  <title>Tienda Buenos Aires</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.7 -->
  <link href="donajoha.ico" rel="shortcut icon">
  <meta charset="UTF-8">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="fa fa-shopping-basket"><b>Tienda Buenos Aires</b></span>
...
//Salida: Viernes 24 de Febrero del 2012  ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
