...
<div class="box-header with-border">
      <a data-toggle="modal" href="#VentaPendiente">
       <button id="btnAgregarArt" type="button" class="btn btn-primary"><span class="fa fa-plus"></span>Ventas</button>
     </a>
...
<!--fin centro-->
  ...
  <!-- fin Modal-->
    ...
    <!--Modal2-->
  <div class="modal fade" id="VentaPendiente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 65% !important;">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
