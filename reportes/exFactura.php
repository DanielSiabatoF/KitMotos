...
//establecemos los datos de la empresa
        ...
        $ext_logo = "png";
        $empresa = "KitMotos";
        $documento = "NIT  24227890";
        $direccion = "CARRERA 23 # 17 - 35";
        $telefono = "313 830 9790 - 310 279 7656";
        $email = "YOPAL - CASANARE";
...
//enviamos datos de la empresa al metodo addSociete de la clase factura
        ...
        $pdf->fact_dev("$regv->tipo_comprobante ", "$regv->moto");
        if ($regv->estado == 'Anulado') {
            $pdf->temporaire($regv->estado);
        } else {
            $pdf->temporaire("");
        }
